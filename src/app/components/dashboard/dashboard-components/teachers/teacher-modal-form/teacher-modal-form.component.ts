...
export class TeacherModalFormComponent implements OnInit {
  ...
  public week: Array<string> = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Satday', 'Sunday'];
  ...
  */
  ...
  /*
    get days that teacher available
  */
  getAvailableDays() {
