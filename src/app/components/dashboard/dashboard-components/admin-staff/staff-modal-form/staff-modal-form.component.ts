...
setDefaultBranchSelection(OrgId){
 ...
 setDefaultPhoto(event) {
  ...
  formGroupAssemble(){
    ...
    if(this.command == 0){
      ...
      console.log(this.whichStaff.RoleName)
      groupObj={
        ...
        IdPhoto:[{ value: this.whichStaff.IdPhoto, disabled:this.readOnlyFlag },],
        ...
        Photo:[{ value: this.whichStaff.Photo, disabled:this.readOnlyFlag }],
