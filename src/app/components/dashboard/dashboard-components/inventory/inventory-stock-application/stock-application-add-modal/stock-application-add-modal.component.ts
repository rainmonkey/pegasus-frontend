...
@Component({
  selector: 'app-stock-application-add-modal',
  templateUrl: './stock-application-add-modal.component.html',
  styleUrls: ['./stock-application-add-modal.component.css']
})
export class StockApplicationAddModalComponent implements OnInit {
  // @Input() name;
